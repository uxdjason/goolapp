...
많은 사람들이 금융상품에 가입할 때 "연 3.0%"와 같은 표면적인 이자율만 보고 가입하지만, 실제로 만기 때 손에 쥐는 금액은 기대보다 적은 경우가 많습니다. 이는 **단리/복리 방식의 차이**와 **이자소득세(15.4%)** 때문입니다. 이 계산기를 사용하면 복잡한 수식 없이도 내가 실제로 받게 될 금액을 정확하게 예측할 수 있습니다.
...
은행에서 홍보하는 이자율은 세금을 떼기 전인 '세전' 기준입니다. 대한민국에서는 금융상품에서 발생한 이자 수익에 대해 **15.4%의 이자소득세 (소득세 14% + 지방소득세 1.4%)**를 부과합니다.
